...
export default function FaultyTerminal({
  ...
  mouseReact = true,
  mouseStrength = 0.2,
  dpr = null, // ✅ CAMBIO: Era window.devicePixelRatio, ahora es null
  ...
  // ✅ NUEVO: Calcula el DPR de forma segura
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({ dpr: actualDpr }); // ✅ CAMBIO: Usa actualDpr
    ...
    actualDpr, // ✅ CAMBIO: Agrega actualDpr como dependencia
    pause,
    timeScale,
    scale,
    gridMul,
